...
The config file is gitignored by default because it contains API tokens. Add your own `markgate.yaml` locally based on `markgate.yaml.example` — it will not be committed.
