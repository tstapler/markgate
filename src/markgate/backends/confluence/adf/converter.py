...
from markgate.backends.confluence.adf.converters import ConverterFactory
from markgate.backends.confluence.adf.nodes import AdfBuilder
...
class AdfConverter:
    ...
    def _filter_duplicate_title_heading(
        ...
        from markgate.backends.confluence.markdown.ast import HeadingNode, TextNode
    ...
    def _extract_text_from_nodes(self, nodes: List[MarkdownNode]) -> str:
        ...
        """
        from markgate.backends.confluence.markdown.ast import TextNode
